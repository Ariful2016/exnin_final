...
import com.exnin.onlinelearning.ViewHolders.CartViewHolder;
import com.exnin.onlinelearning.interfaces.CartDeleteListener;
   ...
   /* public CartAdapter(Context context, List<CartCourse> cartCourseList) {
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, @SuppressLint("RecyclerView") int position) {
       ...
       // Glide.with(context).load(AppConstants.course_image_path + cart.getCourse().getBannerImage()).into(holder.cart_course_img);
        Picasso.get().load(AppConstants.course_image_path + cart.getCourse().getBannerImage()).into(holder.cart_course_img);
